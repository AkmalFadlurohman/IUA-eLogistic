...
@WebService(endpointInterface = "com.IUA.elogistic.task.SupplyInterface")

public class Supply implements SupplyInterface {
	@Override
	public String createRequest(String status, String price, String date, String items, String requester, String email, String type, String source, String destination, String frequency, String sinceDate, String untilDate) throws ServletException,IOException {
		...
		JSONObject jfreq = new JSONObject();
		jfreq.put("type", "String");
		jfreq.put("value", frequency);
		processVariables.put("frequency", jfreq);
